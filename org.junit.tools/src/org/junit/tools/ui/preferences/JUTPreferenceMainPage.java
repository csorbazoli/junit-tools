...
IWorkbenchPreferencePage, IJUTPreferenceConstants {
    ...
    private StringFieldEditor fieldJavaSrcFolder;
    private StringFieldEditor fieldTestSrcFolder;
    ...
    protected void createFieldEditors() {
        ...
        // java source folder
        fieldJavaSrcFolder = new StringFieldEditor(JAVA_SOURCE_FOLDER_NAME,
                Messages.JUTPreferenceMainPage_Test_source_folder_name, getFieldEditorParent());
        addField(fieldJavaSrcFolder);

        // test source folder
        fieldTestSrcFolder = new StringFieldEditor(TEST_SOURCE_FOLDER_NAME,
    ...
    protected void setExampleValueFolder() {
        ...
        if ("".equals(fieldTestSrcFolder.getStringValue())
                || fieldJavaSrcFolder.getStringValue().equals(fieldTestSrcFolder.getStringValue())) {
            srcFolderIsEqual = true;

            folderExample
                    .setText("Java source folder and test source folder are equal");
        } else {
