...
//	page.getView().getTxtTestProject().setText(testProjectName);
    ...
    private void initPageSettings(GeneratorWizardMainPage page, Settings settings) {
        ...
        settings.setSetUpBeforeClass(
                JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.BEFORE_CLASS_METHOD_ENABLED, false));
        settings.setTearDown(JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.AFTER_METHOD_ENABLED, false));
        settings.setTearDownAfterClass(
                JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.AFTER_CLASS_METHOD_ENABLED, false));
        ...
        settings.setThrowsDeclaration(
                JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.THROWS_DECLARATION_ENABLED, true));
        ...
        page.getView().getBtnShowThisDialog().setSelection(
                JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.SHOW_SETTINGS_BEFORE_GENERATE, true));
    ...
    private void updateModelSettings(GeneratorWizardMainPage page, Test tmlTest) {
        ...
        if (page.getView() == null) { // if the dialog was not shown, then take values from the preference store
            settings.setSetUp(
                    JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.BEFORE_METHOD_ENABLED, false));
            settings.setSetUpBeforeClass(
                    JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.BEFORE_CLASS_METHOD_ENABLED, false));
            settings.setTearDown(
                    JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.AFTER_METHOD_ENABLED, false));
            settings.setTearDownAfterClass(
                    JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.AFTER_CLASS_METHOD_ENABLED, false));
            settings.setLogger(JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.LOGGER_ENABLED, false));
            settings.setTestUtils(JUTPreferences.getPreferenceBoolean(IJUTPreferenceConstants.TESTUTILS_ENABLED, true));
            ...
            JUTPreferences.setPreferenceBoolean(IJUTPreferenceConstants.BEFORE_CLASS_METHOD_ENABLED,
                    settings.isSetUpBeforeClass());
            JUTPreferences.setPreferenceBoolean(IJUTPreferenceConstants.AFTER_METHOD_ENABLED, settings.isTearDown());
            JUTPreferences.setPreferenceBoolean(IJUTPreferenceConstants.AFTER_CLASS_METHOD_ENABLED,
                    settings.isTearDownAfterClass());
            ...
            JUTPreferences.setPreferenceBoolean(IJUTPreferenceConstants.THROWS_DECLARATION_ENABLED,
                    settings.isThrowsDeclaration());

            JUTPreferences.setPreferenceBoolean(IJUTPreferenceConstants.SHOW_SETTINGS_BEFORE_GENERATE,
                    page.getView().getBtnShowThisDialog().getSelection());
        }
    }
