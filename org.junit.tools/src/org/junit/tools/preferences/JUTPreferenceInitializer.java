...
public class JUTPreferenceInitializer extends AbstractPreferenceInitializer
    ...
    public static void initDefaultPreferences() {
        ...
        store.setDefault(APPROVALTESTS_ENABLED, false);
        ...
        // default values
        store.setDefault(DEFAULT_VALUE_MAPPING,
                "String=\"Test${Name}\";boolean=true;Boolean=true;byte=63;Byte=63;char='c';Chararcter='c';"
