...
public class TestClassGeneratorTest {
    ...
    public void setupTest() {
        ...
        JUTPreferences.setAdditionalFields(
                new String[] { "@Rule public ExpectedException expected = ExpectedException.none()" });
    ...
    public void testCreateStandardClassFields_shouldNotCreateUnderTestForStaticMethods() throws Exception {
        ...
        underTest.createStandardClassFields(type, "SomeClass", tmlTest);
        // then
        verify(type, never()).createField(anyString(), nullable(IJavaElement.class), anyBoolean(),
    ...
    public void testMocksForDependencies_spring() throws Exception {
        ...
        JUTPreferences
                .setRelevantSpringAnnotations(new String[] { "Controller", "RestController", "Service", "Component" });
        JUTPreferences
                .setMockFramework(IJUTPreferenceConstants.MOCKFW_MOCKITO);
        // when
    ...
    public void testMocksForDependencies_shouldCreateMockMvcForRestController() throws Exception {
        ...
        IType type = Mockito.mock(IType.class);
        org.junit.tools.generator.model.tml.Test tmlTest = new org.junit.tools.generator.model.tml.Test();
        ICompilationUnit baseClass = createSpringClassWithAutowiredField("RestController", "QSomeService;",
                "someService");
    ...
    public void testCreateStandardClassFields_shouldCreateAdditionalFieldsIfConfigured() throws Exception {
        ...
        underTest.createStandardClassFields(type, "SomeClass", tmlTest);
        // then
        verify(type).createField("\t@Rule public ExpectedException expected = ExpectedException.none();", null, false,
                null);
    }
    ...
    public void testCreateStandardStaticImports_shouldUseAssertjAsDefault() throws Exception {
        ...
        verify(baseClass, atLeastOnce()).createImport(importCaptor.capture(), importAboveCaptor.capture(),
                flagCaptor.capture(),
                nullable(IProgressMonitor.class));
    ...
    private ICompilationUnit createSpringClassWithAutowiredField(String annotation, String fieldClass, String fieldName)
            throws JavaModelException {
        return createSpringClassWithField(annotation, fieldClass, fieldName, true);
    }

    private ICompilationUnit createSpringClassWithField(String annotation, String fieldClass, String fieldName,
            boolean autowired) throws JavaModelException {
        ICompilationUnit baseClass = mock(ICompilationUnit.class);
        IType testType = mock(IType.class);
        when(baseClass.getTypes()).thenReturn(new IType[] { testType });
